...
$sql = "SELECT * FROM hospitals where hospital_city = 'Faisalabad'";
...
if ($result) {
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $map = $row['hospital_map'];
            $city = $row['hospital_city'];
            $availability = $row['hospital_availability'];
            $photo_name = $row['hospital_photo']; // Assuming 'doctor_photo' is the column name for photo path
            $photo_path = "assets/img/hopitals/" . $photo_name; // Path to the photo
                ...
                <div class='search-result-item-body'>
                    <div class='row'>
                        <div class='col-sm-9'>
                            ...
                            <p class='info fw-bold'>Phone: $phone</p>
                            <p class='info fw-bold'>Address: $address</p>
                            <p class='info fw-bold'>Availability: $availability </p>
                        </div>
                        <div class='col-sm-3 text-align-center'>
                            <p class='value3 mt-sm'>$city</p>
                            <p class='fs-mini text-muted'>$drspecialization</p>
                            <a class='btn btn-primary btn-info btn-sm' href='$map'>View Location</a>
                        </div>
                    </div>
                </div>
            </section>
